...
An event that the model already predicts carries little information ($I \approx 0$). An event that surprises the model carries much information ($I \gg 0$). The mismatch signal (TF-05) quantifies this surprise.
