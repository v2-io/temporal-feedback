...
*[Derived (from Linear ODE + Linear Coupling Hypotheses)]*
$$\frac{\|\delta_B\|_{ss}}{\|\delta_A\|_{ss}} \approx \frac{\gamma_A}{\gamma_B}\left(\frac{\mathcal{T}_A}{\mathcal{T}_B}\right)^2$$

Under symmetric coupling ($\gamma_A \approx \gamma_B$), this reduces to a squared tempo ratio.
