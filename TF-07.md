...
More generally, an agent may have multiple adaptive processes operating at different rates — with the constraint (TF-08) that faster processes must approximately converge before slower ones act on their output:
