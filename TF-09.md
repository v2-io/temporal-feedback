...
**Epistemic status**: *Derived* from TF-07 (action selection), TF-11 (mismatch dynamics), and TF-04 (event-driven dynamics). The threshold condition (Proposition 9.1) follows cleanly from the mismatch dynamics hypothesis. The specific functional forms for $\Delta\eta^*$ are domain-dependent and less certain.
