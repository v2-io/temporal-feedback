...
| Symbol | Type | Meaning | Defined in |
|--------|------|---------|------------|
| $\mathcal{C}_t$ | Sequence | Interaction history (*chronica*): $(o_1, a_1, o_2, a_2, \ldots, a_{t-1}, o_t)$. The singular, non-forkable causal record of the agent's experience. | TF-02 / TF-03 |
...
| $S_\Pi(M_t)$ | $\in [0, 1]$ | Model sufficiency — operational form (finite horizon $N_h$, policy class $\Pi$). The measured object. | TF-03 |
