...
|--------|----------|------------|--------|
| Prop 5.1: Mismatch Inevitability | TF-05 | TF-01, TF-03 | Proved (sketch; one-step mean-error bridge from insufficiency requires explicit alignment assumption) |
| Prop 9.1: Deliberation Threshold | TF-09 | TF-06, TF-11 | Proved (sketch; conditional on TF-11 hypothesis; see circularity note on $\lvert\delta_{\text{post}}\rvert$) |
